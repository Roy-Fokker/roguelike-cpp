...
the same player object in the all entities list. To draw all of them, there is simple for loop
that just goes over all entities and calls =console_layer::draw=.
