...
#+begin_export html
<ui-code url="https://raw.githubusercontent.com/Roy-Fokker/roguelike/Part-6a/src/main.cpp#L75-L80" width=500 commentWidth=500>
</ui-code>
#+end_export
...
#+begin_export html
<ui-code url="https://raw.githubusercontent.com/Roy-Fokker/roguelike/Part-6b/src/main.cpp#L75-L80" width=500 commentWidth=500>
</ui-code>
#+end_export
...
#+begin_export html
<ui-code url="https://raw.githubusercontent.com/Roy-Fokker/roguelike/Part-6c/src/main.cpp#L75-L80" width=500 commentWidth=500>
</ui-code>
#+end_export

Hitpoints variable is marked as being mutable, so we can modify it, while 
rest of the members are const. I think, this will be changed in future.
...
iteration of C++ standard. We also have to change ~main.cpp~ so that player entity 
