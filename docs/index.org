...
that non of the code is utilizing Win32 specific functionality, it should be 
...
can change it for your specific preference. Other C++ coding guideline, loosely, being followed
is [[http://isocpp.github.io/CppCoreGuidelines/CppCoreGuidelines][C++ Core Guidelines]]. 
